...
import { Color, DoubleSide, Euler, Vector2, Vector3, type ShaderMaterial } from 'three'
...
void main() {
  ...
  // One pixel in world units at this fragment, so the line keeps its screen
  // width at every zoom level and is antialiased for free.
  float px = fwidth(d);
  float line = 1.0 - smoothstep(0.0, uLinePx * px, d);
